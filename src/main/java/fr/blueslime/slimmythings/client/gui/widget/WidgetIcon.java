package fr.blueslime.slimmythings.client.gui.widget;
...
public enum WidgetIcon
{
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(SlimmyThings.MODID, "textures/gui/widgets.png");
