...
public class BlockElectronicPadDesigner extends Block
{
    ...
    public BlockElectronicPadDesigner()
    {
        ...
        this.setRegistryName(SlimmyThings.MODID, "electronic_pad_designer");
        this.setUnlocalizedName(SlimmyThings.MODID + ".electronic_pad_designer");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        playerIn.openGui(SlimmyThings.INSTANCE, ModGuiHandler.ELECTRONIC_PAD_DESIGNER_ID,
