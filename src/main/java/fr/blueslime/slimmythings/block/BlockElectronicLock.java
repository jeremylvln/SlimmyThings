...
@Mod.EventBusSubscriber(modid = SlimmyThings.MODID)
public class BlockElectronicLock extends BlockPeripheral
{
    ...
    public BlockElectronicLock()
    {
        ...
        this.setRegistryName(SlimmyThings.MODID, "electronic_lock");
        this.setUnlocalizedName(SlimmyThings.MODID + ".electronic_lock");
