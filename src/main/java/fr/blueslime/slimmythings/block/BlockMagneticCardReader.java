...
import fr.blueslime.slimmythings.tileentity.TileEntityMagneticCardReader;
...
public class BlockMagneticCardReader extends BlockPeripheral
{
    ...
    public BlockMagneticCardReader()
    {
        ...
        this.setRegistryName(SlimmyThings.MODID, "magnetic_card_reader");
        this.setUnlocalizedName(SlimmyThings.MODID + ".magnetic_card_reader");
