...
import fr.blueslime.slimmythings.integration.computer.ComputerEvent;
import fr.blueslime.slimmythings.integration.computer.ComputerMethodRegistry;
import fr.blueslime.slimmythings.integration.computer.IComputerIntegration;
...
public abstract class TileEntityPeripheral extends TileEntity implements ITickable, IComputerIntegration
{
    ...
    protected boolean assertInteractWithSecurity(EntityPlayer player)
    {
        ...
        {
            player.sendMessage(new TextComponentTranslation("slimmythings.peripheral.access_refused"));
            return false;
        }
