package fr.blueslime.slimeperipherals.client.gui;

import fr.blueslime.slimeperipherals.SlimePeripherals;
import fr.blueslime.slimeperipherals.client.gui.widget.WidgetButton;
import fr.blueslime.slimeperipherals.client.gui.widget.WidgetIcon;
...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation(SlimePeripherals.MODID, "textures/gui/container/electronic_pad_designer.png");
    ...
    {
        String s = I18n.format("container.slimeperipherals.electronic_pad_designer");
